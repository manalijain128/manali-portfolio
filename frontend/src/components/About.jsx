                            ...
                            <div className="relative bg-[#0a0a0a] border border-white/10 rounded-[2.5rem] p-10 text-center w-80 shadow-2xl overflow-hidden">
                                ...
                                >
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="w-full bg-blue-600 text-xl hover:bg-blue-500 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-3 transition-colors shadow-lg shadow-blue-900/20"
                                    >
                                        <FaDownload size={18} />
                                        Resume
                                    </motion.button>
